...
5. **The icon set is a substitution.** `assets/icons/` ships 40 outline SVGs that were not part of the source system; treat them as a stand-in matched to the system's solid, high-contrast character.
