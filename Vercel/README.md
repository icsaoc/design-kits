...
5. **Icons ship; illustration does not.** `assets/icons/` carries 40 outline SVGs. There is no illustration layer, so any richer artwork has to be supplied separately.
