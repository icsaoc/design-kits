...
Pinguo is the fictional product this kit reconstructs; it is filed in this repository as `Apple/` because
the visual language is premium-retail. This is an independent reconstruction, not affiliated with or
endorsed by Apple Inc. and not derived from any official Apple design resource.
...
If creating visual artifacts, build static HTML the user can review. If working on production code, copy the tokens and patterns here so the result keeps Pinguo's restrained, premium-retail merchandising feel.
