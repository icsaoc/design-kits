...
6. **Asset coverage:** `assets/icons/` ships 40 outline SVGs. The propagated variable data carries no icon tokens, so guidance on sizing and color stays stylistic rather than tokenized.
