...
- `SKILL.md` — the skill manifest, stating this system as a contract for coding agents
...
6. **SKILL.md** is listed in the expected library structure but is not currently present in this kit. This README therefore serves as the primary narrative reference for the library at this stage.
